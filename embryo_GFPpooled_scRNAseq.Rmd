...
early_mid_clusters.unlist <- as.data.frame(unlist(early_mid_clusters.list))
early_late_clusters.unlist <- as.data.frame(unlist(early_late_clusters.list))
mid_late_clusters.unlist <- as.data.frame(unlist(early_late_clusters.list))
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_early_dev-mid_late.pdf", height = 10, width = 20)
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_early_dev-mid_late.collapsed.pdf", height = 10, width = 20)
cluster.p1 <- dotplot(bp_early_dev, showCategory = 10, #showCategory = 1,
              title = "GO Enrichment (Biological Process)")
cluster.p1 + theme(
  axis.text.y = element_text(size = 15),
  axis.text.x = element_text(size = 15),
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_mid_dev-early_late.pdf", height = 10, width = 20)
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_mid_dev-early_late.collapsed.pdf", height = 10, width = 20)
cluster.p1 <- dotplot(bp_mid_dev, showCategory = 10, #showCategory = 1,
              title = "GO Enrichment (Biological Process)")
cluster.p1 + theme(
  axis.text.y = element_text(size = 15),
  axis.text.x = element_text(size = 15),
...
#pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_late_dev-early_mid.pdf", height = 10, width = 20)
pdf("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.filteredClustersFINAL.dotPlot-GO-BP_late_dev-early_mid.collapsed.pdf", height = 10, width = 20)
cluster.p1 <- dotplot(bp_late_dev, showCategory = 10, #showCategory = 1, 
              title = "GO Enrichment (Biological Process)") 
cluster.p1 + theme(
  axis.text.y = element_text(size = 15),
  axis.text.x = element_text(size = 15),
