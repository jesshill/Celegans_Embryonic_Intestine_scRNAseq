...
genes <- emb.GFPpooled_v2.filteredClustersFINAL.dotPlot.GO.BP_filtered %>% separate_rows(geneID, sep = "/")  
dim(genes) # 2316   13
str(genes)  
str(genes$geneID)
...
unique(intersect(genes$geneID, genes.background$geneID))
unique(length(intersect(genes$geneID, genes.background$geneID)))


common_genes <- unique(intersect(genes$geneID, genes.background$geneID))
common_genes
length(common_genes)

unique_genes <- unique(setdiff(genes$geneID, genes.background$geneID))
unique_genes
length(unique_genes)
...
genes.all <- emb.GFPpooled_v2.filteredClustersFINAL.dotPlot.GO.BP %>% separate_rows(geneID, sep = "/")  
genes.background.all <- emb.GFPpooled_v2.filteredClustersFINAL.dotPlot.GO.BP.background %>% separate_rows(geneID, sep = "/")  

common_genes.all <- unique(intersect(genes.all$geneID, genes.background.all$geneID))
...
unique_genes.all <- unique(setdiff(genes.all$geneID, genes.background.all$geneID))
